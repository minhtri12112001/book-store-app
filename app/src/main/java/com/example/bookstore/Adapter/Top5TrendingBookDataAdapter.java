...
public class Top5TrendingBookDataAdapter extends RecyclerView.Adapter<Top5TrendingBookDataAdapter.DataViewHolder>{
    private ArrayList<Book> books;
    private Context context;

    public Top5TrendingBookDataAdapter(Context context, ArrayList<Book> books){
    ...
    @NonNull
    @Override
    public Top5TrendingBookDataAdapter.DataViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView;
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.book_view, parent, false);
        Top5TrendingBookDataAdapter.DataViewHolder dataViewHolder = new Top5TrendingBookDataAdapter.DataViewHolder(itemView);
        return  dataViewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull Top5TrendingBookDataAdapter.DataViewHolder holder, int position) {
